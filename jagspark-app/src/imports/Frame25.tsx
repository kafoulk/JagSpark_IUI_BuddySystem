import svgPaths from "./svg-muwa4azf9v";
...
function Group6() {
  return (
    <div className="absolute contents left-[21px] top-[261px]">
...
function Group7() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%+147.5px)] size-[29px] top-[277px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 29 29">
        <g id="Group 63">
          <circle cx="14.5" cy="14.5" fill="var(--fill-0, white)" id="Ellipse 12" r="14" stroke="var(--stroke-0, #D9D9D9)" />
          <path d={svgPaths.p23e32780} fill="var(--fill-0, #B22222)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full">
      ...
      <Group6 />
      <div className="-translate-x-1/2 absolute bg-[rgba(0,0,0,0.8)] border border-[#d9d9d9] border-solid h-[352px] left-[calc(50%-0.5px)] rounded-[20px] top-[261px] w-[359px]" />
      ...
      <p className="-translate-x-1/2 absolute font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] left-1/2 text-[16px] text-center text-white top-[415px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
